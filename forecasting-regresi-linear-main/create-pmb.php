...
<body>
  ...
  <div class="jumbotron m-5">
    ...
    <table class="table">
      ...
      <tbody>
        <?php
            $query = mysqli_query($connect,"select * from sales order by id asc");
            $i = 1;
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" id="inputPassword" name="jumlah" value="<?php echo $obj->jumlah_penjualan; ?>" required>
                        </div>
                      </div>
                    </div>
